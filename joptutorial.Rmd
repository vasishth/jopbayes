...
This file provides the main code snippets in the paper.
...
```{r fitMandarindata,cache=TRUE,include=FALSE,warning=FALSE,message=FALSE}
...
stanplot(m1M, pars = c("^b","sd","sigma"))
```
...
```{r fitmemodel,cache=TRUE,include=FALSE,warning=FALSE,message=FALSE}
